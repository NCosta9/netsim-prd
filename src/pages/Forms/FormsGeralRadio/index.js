...
export default function FormsGeralRadio() {
      ...
      >
        ...
        <div className="mb-3">
          ...
          >
            ...
            <option value="Inter Digital R$ 99,90" >Inter Digital R$ 99,90</option>
            <option value="Master Digital R$ 129,90" >Maste Digital R$ 129,90</option>
            <option value="Plus Digital R$ 149,90" >Plus Digital R$ 149,90</option>
          </select>
        </div>
