    ...
    <>
        ...
        <div className="card-laranja">
          <div className="row">
            <div className="col-sm-9">
              <h5 className="text-light text-custom p-3"> Conheça agora os nossos planos de internet!</h5>
            </div>
            <div className="col-auto text-end m-3">
              <button className="btn btn-light mt-4 btn-lg fs-4 " onClick={() => navigate("/cobertura")}> Confira</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container text-center mt-5">
        <div className="row position-relative">
          <div className="col">
            <img className="figura-cell fs-3" src={mockupAppAssinante} width="300" />
          </div>
          ...
          <div className="col d-flex flex-column position-static">
            ...
            <div className="row flex-md-row position-relative mx-1">
              <div id="bg-laranja" className="col card me-2 align-items-center text-light d-flex flex-column position-static">
              ...
              <div id="bg-laranja" className="col card align-items-center text-light">
                <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="mt-3" >
                  ...
                  <a className='link-reset' href='https://ixc.netsimtelecom.com.br/central_assinante_web/login d-flex flex-column position-static'>
                    <h5 className="card-text fs-6">Pagamento com PIX </h5>
                  </a>
