    ...
    <div className='display-flex'>
      ...
      <div class="mt-0">
        <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="https://netsimtelecom.com.br/wp-content/uploads/2022/05/home-banner-02-1.jpg" class="d-block w-100" alt="..." />
              <div class="carousel-caption text-end d-none d-md-block">
                <p class="titulo-home">Bem- Vindo a</p>
                <img class="alignright" src="https://netsimtelecom.com.br/wp-content/uploads/2021/11/logo-branca.png" width="400" />
                <p class="subtitulo-home">Planos de ultravelocidade
            ...
            <div class="carousel-item">
              <img src="https://netsimtelecom.com.br/wp-content/uploads/2022/05/BANNER_PLANOS_FIBRA-OTICA.png" class="d-block w-100" alt="..." />
        ...
        <p>Some representative placeholder content for the second slide.</p>
            ...
            <div class="carousel-item">
              <img src="https://netsimtelecom.com.br/wp-content/uploads/2022/09/Banner-migracao-radio-par-fibra.jpg" class="d-block w-100" alt="..." />
              <div class="carousel-caption d-none d-md-block">
                ...
                <p><button type="button" class="btn-netsim">CLIQUE AQUI</button></p>
              </div>
            </div>
          </div>
      ...
      <div class="container px-4 py-5" id="featured-3">
        <h2 class="pb-2 divider-orange">Escolha o que deseja...</h2>
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
          <div class="feature col">
            <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-router m-2" viewBox="0 0 16 16">
            ...
            <h3 class="fs-2">Planos de Internet</h3>
            <p>Planos apartir de R$ 99,90 + ultima tecnologia wi-fi do mercado </p>
            <a href="#" class="icon-link d-inline-flex align-items-center link-orange">
              Saiba Mais
          ...
          <div class="feature col">
            <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-telephone m-2" viewBox="0 0 16 16">
            ...
            <h3 class="fs-2">Planos de Telefonia</h3>
          ...
          <div class="feature col">
            <div class="feature-icon d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-2 mb-3">
              <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-building m-2" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M14.763.075A.5.5 0 0 1 15 .5v15a.5.5 0 0 1-.5.5h-3a.5.5 0 0 1-.5-.5V14h-1v1.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V10a.5.5 0 0 1 .342-.474L6 7.64V4.5a.5.5 0 0 1 .276-.447l8-4a.5.5 0 0 1 .487.022zM6 8.694 1 10.36V15h5V8.694zM7 15h2v-1.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5V15h2V1.309l-7 3.5V15z" />
                <path d="M2 11h1v1H2v-1zm2 0h1v1H4v-1zm-2 2h1v1H2v-1zm2 0h1v1H4v-1zm4-4h1v1H8V9zm2 0h1v1h-1V9zm-2 2h1v1H8v-1zm2 0h1v1h-1v-1zm2-2h1v1h-1V9zm0 2h1v1h-1v-1zM8 7h1v1H8V7zm2 0h1v1h-1V7zm2 0h1v1h-1V7zM8 5h1v1H8V5zm2 0h1v1h-1V5zm2 0h1v1h-1V5zm0-2h1v1h-1V3z" />
              </svg>        </div>
            <h3 class="fs-2">Planos Empresariais</h3>
      ...
      <div class="container">
        <div class=" card align-items-center text-center inline p-3 border-orange">
          <img class="mt-5" src="https://netsimtelecom.com.br/wp-content/uploads/2022/05/logotipo-removebg-preview-e1654348971421.png" width="200" height="50" />
          <div class="row featurette">
            <div class="col-md-7 mt-5">
              <h2 class="featurette-heading fw-normal lh-1">Aplicativos de entretenimento <span class="text-muted">Para toda a familia.</span></h2>
              <p class="lead">Escolha um plano e tenha acesso aos nossos aplicativos standard e premium e garanta diversão para toda a familia.</p>
              <button class="btn btn-netsim">Saiba mais</button>
            </div>
            <div class="col-md-5">
      ...
      <div class="container shadow-lg pb-5">
        <h1 class="display-4 fw-bold text-center mt-5"> Nossos valores</h1>
        <h5 class="text-dark">CONFIABILIDADE</h5>
        <div class="progress">
          <div id="progress-bar-100" class="progress-bar" role="progressbar" aria-label="Example with label" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">100%</div>
        </div>
        <h5 class="text-dark">PRODUTIVIDADE</h5>
        <div class="progress">
          <div id="progress-bar-100" class="progress-bar" role="progressbar" aria-label="Example with label" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">100%</div>
        </div>
        <h5 class="text-dark">EXCLUSIVIDADE</h5>
        <div class="progress">
          <div id="progress-bar-100" class="progress-bar" role="progressbar" aria-label="Example with label" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">100%</div>
        </div>
        <h5 class="text-dark">VELOCIDADE</h5>
        <div class="progress">
          <div id="progress-bar-100" class="progress-bar" role="progressbar" aria-label="Example with label" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">100%</div>
        </div>
      ...
      <div class="container">
        <div class="">
          <div class="px-4 pt-5 my-5 text-center divider-orange">
            <h1 class="display-4 fw-bold">Clube de descontos</h1>
            <div class="col-lg-6 mx-auto">
              <p class="lead mb-4">A Netsim tem parceria com mais de 3 mil marcas e 25 mil estabelecimentos. E nossos clientes ganham acesso ao nosso clube de descontos com mais de 3 mil marcas com descontos exclusivos todos os dias.</p>
              <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
                <button type="button" class="btn btn-primary btn-lg px-4 me-sm-3"><Link className="link-reset" to="/cobertura">Contratar internet</Link></button>
                {values.map((v, idx) => (
                  <button type="button" key={idx} class="btn btn-outline-orange btn-lg px-4" onClick={() => handleShow(v)}>Saiba Mais</button>
                ))}
              </div>
            </div>
            <div class="overflow-hidden">
              <div class="container px-5">
                <img src={Lecupon} class="img-fluid mb-1" width="300" height="100" loading="lazy" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <h1 class="display-4 fw-bold text-center p-3">Dúvidas frequentes</h1>
        <div class="card">
          <Perguntasfrequentes />
        </div>
      </div>
      ...
      <div class="container mt-5">
        <div class="card-laranja">
          <div class="row">
            <div class="col mx-5">
              <h5 class="text-light text-custom"> Conheça agora os nossos planos de internet!</h5>
            </div>
            <div class="col p-5 text-end">
              <button class="btn btn-light mt-4 btn-lg"> Confira</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container text-center mt-5">
        <div class="row">
          <div class="col">
            <img class="figura-cell" src="https://netsimtelecom.com.br/wp-content/uploads/2021/11/download1-1.png" height="500" />
          </div>
          <div class="col align-middle">
            <div class="container-fluid py-5">
              <h6 class="display-5 fw-bold me-5 mb-5">Autoatendimento para clientes</h6>
              <div class="row">
                <div id="bg-laranja" class="col card me-2 align-items-center text-light">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-terminal-plus mt-3" viewBox="0 0 16 16">
                ...
                <div id="bg-laranja" class="col card align-items-center text-light">
                  <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="mt-3" >
                ...
                <div id="bg-laranja" class="col card ms-2 align-items-center text-light">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-wrench-adjustable mt-3" viewBox="0 0 16 16">
                ...
                <div id="bg-laranja" class="col card ms-2 align-items-center text-light">
                  <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-speedometer2 mt-3" viewBox="0 0 16 16">
