                    ...
                    <header className="blog-header lh-1 py-3">
                        <div className="row flex-nowrap justify-content-between align-items-center">
                            ...
                            <div className="col-4 d-flex justify-content-end align-items-center">
                                ...
                                <a className="btn btn-sm btn-outline-secondary" href="/">Ligue pra mim</a>
                            </div>
                        </div>
                    </header>
                </div>
                ...
                <main className="container">
                    <div className="p-4 p-md-5 mb-4 rounded text-bg-dark">
                        <div className="col-md-6 px-0">
                            ...
                            <p className="lead mb-0"><a href="/" className="text-white fw-bold">Voltar para Página principal</a></p>
                        </div>
                    </div>
                        ...
                        <div className="col-md-6">
                            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                <div className="col p-4 d-flex flex-column position-static">
                                    ...
                                    <a href="/" className="btn btn-outline-primary">Acessar</a>
                                </div>
                        ...
                        <div className="col-md-6">
                            <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                <div className="col p-4 d-flex flex-column position-static">
                                    ...
                                    <a href="https://www.portaldoassinante.com/netsim" className="btn btn-outline-primary">Acessar</a>
                                </div>
                                <div className="col-auto d-none d-lg-block">
                                        ...
                                        <div className="col align-middle">
                                            <div className="container-fluid">
                                                <div className="row row-cols-2 row-cols-sm-3 row-cols-md-4">
                                                    <div id="bg-laranja" className="col card mx-2 my-2 align-items-center text-light">
                                                        ...
                                                        <a className='link-reset' href='https://ixc.netsimtelecom.com.br/central_assinante_web/login'>
