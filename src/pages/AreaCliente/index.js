                    ...
                    <header class="blog-header lh-1 py-3">
                        <div class="row flex-nowrap justify-content-between align-items-center">
                            ...
                            <div class="col-4 text-center">
                                <a class="blog-header-logo text-dark" href="#">Area do cliente</a>
                            </div>
                            <div class="col-4 d-flex justify-content-end align-items-center">

                                <a class="btn btn-sm btn-outline-secondary" href="#">Ligue pra mim</a>
                            </div>
                        </div>
                    </header>
                </div>
                ...
                <main class="container">
                    <div class="p-4 p-md-5 mb-4 rounded text-bg-dark">
                        <div class="col-md-6 px-0">
                            <h1 class="display-4 fst-italic">Bem- vindo a nossa area do cliente </h1>
                            <p class="lead my-3">
                                Através desse canal em nosso site, os nossos clientes encontrara todas as novidade relacionadas aos nossos serviços. Alem disso, todos
                                as operações de facilidade para o cliente conseguira ser realizado por aqui.
                            </p>
                            <p class="lead mb-0"><a href="#" class="text-white fw-bold">Role a pagina....</a></p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                <div class="col p-4 d-flex flex-column position-static">
                                    <strong class="d-inline-block mb-2 text-primary">Veja</strong>
                                    <h3 class="mb-0">Clube de Descontos</h3>
                                    <p class="card-text mb-auto">Aplicativo que garante a você descontos em estabelecimentos em sua região.</p>
                                    <a href="#" class="stretched-link">Como configurar</a>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                <div class="col p-4 d-flex flex-column position-static">
                                    <strong class="d-inline-block mb-2 text-success">Veja</strong>
                                    <h3 class="mb-0">Portal de Aplicativos</h3>
                                    <p class="mb-auto">Acesse agora esse portal para escolher quais aplicativos deseja utilizar</p>
                    ...
                    <div class="row g-5">
                        <div class="col-md-8">
                            <h3 class="pb-4 mb-4 fst-italic divider-orange">
                                Notícias
                            </h3>
                        ...
                        <div class="col-md-4">
                            <div class="position-sticky">
                                ...
                                <div class="p-4">
                                    <h4 class="fst-italic">Serviços:</h4>
                                    <ol class="list-group ">
                                ...
                                <div class="p-4">
                                    <h4 class="fst-italic">Nossas Redes:</h4>
