                ...
                <div className="col-md-3">
                    <div className="card mb-4 rounded-3 shadow-sm">
                        <div className='card-planos'>
                            ...
                            <div className="card-header py-3" style={{ background: '#DCDCDC' }}>
                                <h4 className="my-0 fw-normal">Plus Digital</h4>
                            </div>
                            <div className="card-body ">
                                <small className="text-muted fw-light"><p className='text-start mb-0'>Velocidade</p></small>
                                <h3 className="my-0 mb-3 fw-normal offer_title text-start">50 MEGA</h3>
                            ...
                            <div className="card-footer" style={{ background: '#DCDCDC' }}>
                                <div id="ultra-collapse-text">
                                    ...
                                    <ul className="list-unstyled mt-3 mb-4 text-start">
                                        ...
                                        <div className="d-inline gap-2 d-sm-flex justify-content-sm-center ms-3">
                ...
                <div className="col-md-3">
                    <div className="card mb-4 rounded-3 shadow-sm">
                        <div className='card-planos'>
                            ...
                            <div className="card-header py-3" style={{ background: '#DCDCDC' }}>
                                <h4 className="my-0 fw-normal">Master Digital<span id="especific" className="position-absolute top-0 start-50 translate-middle badge rounded-1 bg-orange">
                                    Recomendado
                                </span></h4>
                            </div>
                            <div className="card-body">
                ...
                <div className="col-md-3">
                    <div className="card mb-4 rounded-3 shadow-sm border-primary ">
                        <div className='card-planos'>
                            ...
                            <div className="card-body ">
                                <small className="text-muted fw-light"><p className="text-start mb-0">Velocidade</p></small>
                                <h3 className="my-0 mb-3 fw-normal offer_title text-start ">20 MEGA</h3>
                                <small className="text-muted fw-light"><p className="text-start mb-0">Apenas</p></small>
                                <h2 className="card-title pricing-card-title fw-light text-start">R$114,90<small className="text-muted fw-light">/mês</small></h2>
                    ...
                    <div className="card mb-4 rounded-3 shadow-sm">
                        <div className='card-planos'>
                            ...
                            <div className="card-body">
                                ...
                                <button type="button"  className="w-100 btn btn-lg btn-primary mt-3"><Link className='link-reset' to="/lite">Assinar</Link></button>
                            </div>
                            <div className="card-footer" style={{ background: '#DCDCDC' }}>
                                <small className="text-muted fw-light"><p className='text-start mb-0'>Benefícios do plano:</p></small>
                                <ul className="list-unstyled mt-3 mb-4 text-start">
