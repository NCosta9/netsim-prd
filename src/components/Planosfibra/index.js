                                ...
                                <div id="ultra-collapse-text">
                                    <ul class="list-unstyled mt-3 mb-4 text-start">
                                        ...
                                        <div class="d-inline gap-2 d-sm-flex justify-content-sm-center ms-3">
                                            <img className="ms-1" height="20" width="20" src='https://rgdwsabzajcksicdqvja.supabase.co/storage/v1/object/public/imagens/apps/playkids' />
                                            <img className="ms-1" height="20" width="20" src='https://rgdwsabzajcksicdqvja.supabase.co/storage/v1/object/public/imagens/apps/deezer' />
                                            <img className="ms-1" height="20" width="20" src='https://rgdwsabzajcksicdqvja.supabase.co/storage/v1/object/public/imagens/apps/looke' />
                                        ...
                                        <div class="d-inline gap-2 d-sm-flex justify-content-sm-center ms-3">
                                            <img className="ms-1" height="20" width="20"src='https://rgdwsabzajcksicdqvja.supabase.co/storage/v1/object/public/imagens/apps/ritualfit' />
                                            <img className="ms-1" height="20" width="20" src='https://rgdwsabzajcksicdqvja.supabase.co/storage/v1/object/public/imagens/apps/doutorpass' />
                                            <img className="ms-1" height="20" width="20" src='https://rgdwsabzajcksicdqvja.supabase.co/storage/v1/object/public/imagens/apps/hbomax' />
                                            <ModalVerMaisPremium />
                                        </div>
                                    </ul>
                                </div>
