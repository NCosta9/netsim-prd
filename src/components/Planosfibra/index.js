                                ...
                                <div id="ultra-collapse-text">
                                    ...
                                    >
                                        ...
                                        <div class="d-inline gap-2 d-sm-flex justify-content-sm-center ms-3">
                                            <img className="ms-1" height="20" width="20" src={standard1} />
                                            <img className="ms-1" height="20" width="20" src={standard4} />
                                            <img className="ms-1" height="20" width="20" src={standard8} />
                                        ...
                                        <div class="d-inline gap-2 d-sm-flex justify-content-sm-center ms-3">
                                            <img className="ms-1" height="20" width="20" src={premium1} />
                                            <img className="ms-1" height="20" width="20" src={premium2} />
                                            <img className="ms-1" height="20" width="20" src={premium4} />
                                            <ModalVerMaisPremium />
                                        </div>
                                    </ul>
                                </div>
