        ...
        <>
            <div class="container text-start">
                <div class="row">
                    {/* Ritual fit */}
                    <div class="col">
                            <img src='https://hdflgabrcqndyvcnyjtn.supabase.co/storage/v1/object/public/imagens/apps/ritualfit' class="mt-3" alt="..." height="80" width="80"/>
                                <div class="card-body">
                     ...
                     {/* Doutorpass */}
                    <div class="col">
                            <img src='https://hdflgabrcqndyvcnyjtn.supabase.co/storage/v1/object/public/imagens/apps/doutorpass' class="mt-3" alt="..." height="80" width="80"/>
                                <div class="card-body">
                ...
                <div class="row">
                    {/* Sexy hot */}
                    <div class="col">
                            <img src='https://hdflgabrcqndyvcnyjtn.supabase.co/storage/v1/object/public/imagens/apps/sexyhot' class="mt-3" alt="..." height="80" width="80"/>
                                <div class="card-body">
                     ...
                     {/* HBO max */}
                    <div class="col">
                            <img src='https://hdflgabrcqndyvcnyjtn.supabase.co/storage/v1/object/public/imagens/apps/hbomax' class="mt-3" alt="..." height="80" width="80"/>
                                <div class="card-body">
