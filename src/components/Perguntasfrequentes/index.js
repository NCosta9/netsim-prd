...
<>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-heading1">
      ...
      COMO FUNCIONA O SUPORTE DA EMPRESA? </button>
    </h2>
    <div id="flush-collapse1" class="accordion-collapse collapse" aria-labelledby="flush-heading1" data-bs-parent="#accordionFlush">
      ...
      Basta entrar em contato por algum dos nossos canais de atendimento, que de acordo com o grau do problema imediatamente abrimos uma O.S para os técnicos estarem indo até a residência do cliente para realizar o reparo sem custos adicionais
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-heading2">
      ...
      QUANTAS HORAS PARA REALIZAR A INSTALAÇÃO?
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-heading3">
      ...
      PRECISO PAGAR OS EQUIPAMENTOS QUE VÃO SER INSTALADOS?
      </button>
    </h2>
    <div id="flush-collapse3" class="accordion-collapse collapse" aria-labelledby="flush-heading3" data-bs-parent="#accordionFlush">
      <div class="accordion-body">
      Não, todos os equipamentos são por nossa conta, tendo qualquer problema fazemos a troca sem nenhum custo adicional.
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item bg">
    ...
    <div id="flush-collapse5" class="accordion-collapse collapse" aria-labelledby="flush-heading5" data-bs-parent="#accordionFlush">
      <div class="accordion-body">
      Nós da Netsim Telecom terceirizamos o setor de cadastro e uma exigência é que não tenha nenhuma restrição no CPF.
    </div>
  </div>
